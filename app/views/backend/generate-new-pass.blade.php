            ...
            <div class="tab-content">
                <div id="login" class="tab-pane active">
                    {{ Form::open(['url' => 'dashboard/login', 'class' => 'form-signin', 'id' => 'loginForm']) }}
                        ...
                        <div class="alert alert-dismissable hidden" id="js-feedback">
            ...
            jQuery(document).ready(function($) {
                ...
                $('form#loginForm').submit(function(e)
                {
                    ...
                    $.post(action, {_token: token, email: email, password:password, remember: remember}, function(data)
                    {
                        ...
                        {
                            $('#login #js-feedback').removeClass('alert-danger hidden').addClass('alert-success').text(data['success']);
                        ...
                        {
                            $('#login #js-feedback').removeClass('alert-success hidden').addClass('alert-danger').text(data['email']);
                        } 

                        if (data['password'] !=undefined)
                        {
                            $('#login #js-feedback').removeClass('alert-success hidden').addClass('alert-danger').text(data['password']);
                        } 
                    }, 'json'); 
