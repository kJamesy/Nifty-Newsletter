    ...
    <div class="col-lg-12">
        <div class="box info">
            <header>
                ...
                <h5>New Tag</h5>
                <div class="toolbar">
                    <a class="btn btn-default btn-sm btn-flat disabled" href="{{URL::to('dashboard/tags/create')}}"><span class="fa fa-pencil"></span> New Tag</a>
                </div>                
            </header>
        </div><!-- /.box -->
    </div>
    <div class="col-md-12">
        {{Form::open(['url' => 'dashboard/tags/store', 'class' => 'form-horizontal'])}}  
            <div class="row">
