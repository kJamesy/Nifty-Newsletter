<html lang="en">
    <head>
        ...
        <meta charset="utf-8">
        <title>{{ $configs->sitename }} - Hello</title>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Hey person!</p>
                        <p>You found this page, well done!</p>
                        <p>Next, click (<a style="text-decoration: underline" href="{{ URL::to('dashboard') }}">here</a>) to proceed should you want to.</p>
                    </div>
