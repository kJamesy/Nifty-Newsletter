...
return array(
    ...
    */
    'properties' => array(
        'creator'           => 'Nifty Newsletter',
        'lastModifiedBy'    => 'Nifty Newsletter Admin',
        'title'             => 'Spreadsheet',
        'description'       => 'Default spreadsheet export',
        'subject'           => 'Spreadsheet export',
        'keywords'          => 'Nifty, Newsletter, excel, export',
        'category'          => 'Excel',
        'manager'           => 'Admin',
        'company'           => 'Nifty Newsletter',
    ),
    ...
    */
	...
	'creator' => 'Nifty Newsletter Admin',
